...
public class KeywordSearchTest {
	...
	public void verifyHomePage() {
		BasePage.logger = BasePage.extent.createTest("Keyword Search Test");
	...
	public void categorySearchTest() {
		...
		searchText.setSearchText(prop.getProperty("keywordsearch"));
	...
	@Test(priority = 5,dependsOnMethods={"VerifyCourseDetailPage"})
